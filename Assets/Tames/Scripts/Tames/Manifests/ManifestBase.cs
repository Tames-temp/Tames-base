...
namespace Tames
{
    public class ManifestBase
    {
        ...
        public ContinuityMode cycle = ContinuityMode.Stop;
       ...
       //             Debug.Log("duration " + manager.Duration + " " + mh.items[0]);
        ...
        public TameCustomValue CreateInput(string name)
        {
            ...
            {
                continuity = ContinuityMode.Cycle
            };
        ...
        {
            return TameTrigger.TriggerFromText(s);
        }

        public static TameTrigger ReadTriggerO(string s)
        {
        ...
        private void ReadCycle(ManifestHeader mh)
        {
            ...
            {
                ManifestKeys.Cycle => ContinuityMode.Cycle,
                ManifestKeys.Reverse => ContinuityMode.Reverse,
                _ => ContinuityMode.Stop
            };
            if (mh.items.Count >= 1)
            {
                if (Utils.SafeParse(mh.items[0], out f))
