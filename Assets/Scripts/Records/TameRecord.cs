...
namespace Records
{
    ...
    public class TameFullRecord
    {
        ...
        public void ExportToCSV(string folder, ExportOption eo)
        {
            ...
            s += (eo.actionKeys ? "Keys," : "") + (eo.actionMouse ? "Mouse," : "") + (eo.actionGamePad ? "Gamepad," : "") + (eo.actionVRController ? "VR," : "");
            lines.Add(s);
            // Data
            for (int j = 0; j < allRecords.frame.Count; j++)
            {
                ...
                if (changed)
                {
                    ...
                    if (eo.actionKeys)
                        s += f.keyMap.Export(f.keyMap.pressed, keyNames) + "," + f.keyMap.Export(f.keyMap.hold, keyNames) + ",";
                    if (eo.actionMouse)
                        s += f.keyMap.mouse.Export(f.keyMap.mouse.pressed) + "," + f.keyMap.mouse.Export(f.keyMap.mouse.hold) + ",";
                    if (eo.actionGamePad)
                        s += f.keyMap.gpMap.ExportStatus(f.keyMap.gpMap.pressed) + "," + f.keyMap.gpMap.ExportStatus(f.keyMap.gpMap.hold) + "," + f.keyMap.gpMap.ExportValue() + ",";
                    if (eo.actionVRController)
